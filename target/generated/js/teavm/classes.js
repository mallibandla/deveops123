...
function TC($this,a){var b,c,d,e,f,g;if((a!=0)){a=(a<<1);}else{a=1;}a=SB(a);b=WB($this,a);c=0;d=((a-1)|0);while((c<$this.KB.data.length)){e=$this.KB.data[c];$this.KB.data[c]=null;while((e!==null)){f=(e.DC&d);g=e.FC;a=b.data;e.FC=a[f];a[f]=e;e=g;}c=((c+1)|0);}$this.KB=b;XB($this);return;}
...
function E($this,a,b,c,d){var e,f;if(((a>=0)&&((a<=b)&&((b<=$this.PD())&&(d>=0))))){e=((d+((b-a)|0))|0);f=c.data;if((e<=f.length)){while((a<b)){c=((d+1)|0);e=((a+1)|0);f[d]=$this.QD(a);d=c;a=e;}return;}}$rt_throw(W.X());}
